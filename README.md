...
## Proteção Portal Notarial Pro v5

Esta versão preserva as rotas protegidas e revisa a Home pública para venda:

- mantém mensagens visuais e animação no hero;
- adota estética mais limpa e moderna;
- usa texto comercial para apresentar o Portal Notarial Pro;
- mantém apenas cards normativos na área pública;
